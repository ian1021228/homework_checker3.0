            ...
            hwItem.innerHTML = `
                ...
                <div class="flex justify-between items-start relative z-10">
                    ...
                    <div class="flex items-center gap-1 flex-shrink-0 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity">
                        <button type="button" data-id="${hw.id}" class="voice-broadcast-btn text-slate-400 hover:text-indigo-600 p-2.5 rounded-2xl hover:bg-indigo-50 transition-all cursor-pointer" title="語音廣播催繳此作業"><i class="fa-solid fa-volume-high text-base"></i></button>
                        <button type="button" data-id="${hw.id}" class="copy-defaulters-btn text-slate-400 hover:text-amber-600 p-2.5 rounded-2xl hover:bg-amber-50 transition-all cursor-pointer" title="複製未交名單（純文字）"><i class="fa-solid fa-bullhorn text-base"></i></button>
